...
#-2.94014 -0.62820  0.12008  0.00493  0.66258  2.74530 
...
#Min.    1st Qu.     Median       Mean    3rd Qu.       Max. 
#-2.847720 -0.746924 -0.000692 -0.002028  0.672000  4.074221 
...
#Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
0.9991  0.9997  1.0000  1.0003  1.0006  1.0072 
...
# save chain objects
save(kendall.chain,file="kendall_chain_no_perf.Rdata")
save(mutual.chain,file="mutual_chain_no_perf.Rdata")
save(norm_mutual.chain,file="norm_mutual_chain_no_perf.Rdata")
