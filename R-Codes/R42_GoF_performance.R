...
#write.csv2(pval_g,file="pval_item.txt")

write.csv2(pval_prof,file="pval_prof_perf.txt")
write.csv2(pval_item,file="pval_item_perf.txt")
write.csv2(pval_g,file="pval_g_perf.txt")